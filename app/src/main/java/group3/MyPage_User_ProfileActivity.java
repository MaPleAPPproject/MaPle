...
public class MyPage_User_ProfileActivity extends Activity {
...
//        startActivity(intent);
    ...
    public void onImageClick(View view) {
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(MyPage_User_ProfileActivity.this).create();
        alertDialog.show();
