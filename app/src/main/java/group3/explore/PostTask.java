...
public class PostTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "PostTask";
    private String url;
    ...
    public PostTask(String url, int id, int imageSize) {
        this(url,id,imageSize,null);
    }

    public PostTask(String url, int id, int imageSize, ImageView imageView) {
        this.url = url;
        this.id = id;
